    ...
    <PageLayout>
      <section className="pt-32 pb-16 lg:pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-20 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-amber-100 dark:bg-amber-950/30 text-amber-700 dark:text-amber-400 text-sm font-medium rounded-full mb-6">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link
                  href="/pricing"
                  className="inline-flex items-center gap-2 px-8 py-3.5 text-base font-semibold text-amber-600 dark:text-amber-400 border-2 border-amber-200 dark:border-amber-800/30 rounded-xl hover:border-amber-400 transition-all"
                >
            ...
            {benefits.map((b: { title: string; description: string }, i: number) => {
              ...
              return (
                <div key={b.title} className="p-6 bg-card rounded-xl border border-border">
                  <div className="w-10 h-10 bg-amber-100 dark:bg-amber-950/30 rounded-lg flex items-center justify-center mb-4">
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-foreground mb-6">{t("solutions.construction.ctaHeading")}</h2>
          <p className="text-muted-foreground mb-8">{t("solutions.construction.ctaDesc")}</p>
          <Link
            href="/register"
          ...
          <p className="mt-3 text-sm text-muted-foreground">{t("solutions.construction.ctaFootnote")}</p>
        </div>
      </section>
    </PageLayout>
  );
