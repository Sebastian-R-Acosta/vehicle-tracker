...
export async function PUT(
  ...
  const { make, model, year, vin, licensePlate, nickname, currentMileage, vehicleType, status, hoursMeter, serialNumber, weightCapacity, constructionSiteId, equipmentStatus } = body;
