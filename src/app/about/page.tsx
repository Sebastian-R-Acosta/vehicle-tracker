      ...
      <section className="pt-32 pb-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold text-foreground mb-4">{t("common.aboutTitle")}</h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-4">{t("common.aboutMission")}</h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("common.aboutMissionText")}
              </p>
            </div>
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-4">{t("common.aboutVision")}</h2>
              <p className="text-muted-foreground leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-foreground text-center mb-10">{t("common.aboutCoreValues")}</h2>
            ...
            {values.map((v) => {
              ...
              return (
                <div key={v.titleKey} className="text-center">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-2">{t(v.titleKey)}</h3>
