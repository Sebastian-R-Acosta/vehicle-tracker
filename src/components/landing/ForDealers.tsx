...
export default function ForDealers() {
  ...
  return (
    <section id="for-dealers" className="py-16 lg:py-24 bg-secondary/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-sm font-medium rounded-full mb-6">
            ...
            <Link
              ...
              className="inline-flex items-center gap-1 mt-6 py-3 text-sm text-blue-600 dark:text-blue-400 hover:text-blue-500 font-medium"
            >
