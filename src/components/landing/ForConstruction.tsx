      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {(t("landing.forConstructionSection.benefits") as { title: string; description: string }[]).map((b, i) => {
            ...
            return (
              <div key={b.title} className="p-6 neu-bg rounded-2xl neu-shadow">
        ...
        <div className="text-center">
          <Link
            ...
            className="inline-flex items-center gap-2 px-8 py-3.5 text-base font-semibold text-white bg-amber-600 rounded-xl hover:brightness-110 transition-all neu-shadow-sm"
          >
