...
export const en: Translations = {
  common: {
    ...
    orgSlug: "URL slug",
    orgCreateSuccess: "Organization created",
    orgUpgradeRequired: "Creating organizations requires a Pro plan",
    orgUpgradeDesc: "Upgrade to Pro to unlock organizations and manage your team under a single account.",
    ...
    aboutValueSimplicityDesc: "Powerful tools don't have to be complicated. We design for ease of use.",
    aboutValueSecurity: "Security",
    aboutValueSecurityDesc: "Your data is encrypted and protected. You control who has access.",
    aboutValueInnovation: "Innovation",
    aboutValueInnovationDesc: "We continuously improve our platform to serve you better.",
  },
  nav: {
    dashboard: "Dashboard",
    vehicles: "Vehicles",
  ...
  landing: {
    ...
    footerDescription: "The most comprehensive vehicle history and maintenance platform in the region. Track, manage, and share service records with confidence.",
    footerRights: "All rights reserved.",
    statVehiclesTracked: "Vehicles Tracked",
    statDealerships: "Dealerships",
    statServiceRecords: "Service Records",
    features: {
    ...
    forIndividualsSection: {
      ...
      description: "Never wonder when your last oil change was again. Bitácora keeps every service, receipt, and reminder in one place — completely free to start.",
    ...
    forDealersSection: {
      ...
      description: "Stop chasing paper. Bitácora gives your dealership a competitive edge with digital service records, automated customer communication, and powerful reporting.",
    ...
    forConstructionSection: {
      ...
      description: "Track hours, manage sites, and keep your fleet running. Bitácora works just as hard as your equipment.",
      learnMore: "Learn More",
      benefits: [
    ...
    forInsurersSection: {
      ...
      description: "Make underwriting decisions with confidence. Bitácora gives insurers a complete view of every vehicle's maintenance history, service gaps, and ownership changes.",
    ...
    testimonialsSection: {
      ...
      subtitle: "See what dealerships and insurance companies are saying about Bitácora.",
      items: [
        { quote: "Bitácora transformed our service department. We've seen a 30% increase in repeat visits and our customers love the transparency.", name: "Michael Torres", role: "Service Director, AutoNation" },
  ...
  license: {
    ...
    reminders: {
      ...
      notify90: "90 days before expiry",
      notify30: "30 days before expiry",
      notifyExpiry: "On expiry date",
      pushDescription: "Receive browser push notifications for license renewal",
    },
  },
  maintenance: {
    title: "Maintenance",
  ...
  solutions: {
    dealers: {
      ...
      ctaDesc: "Join dealerships across the country using Bitácora.",
    ...
    insurers: {
      ...
      ctaHeading: "See how insurers are using Bitácora",
    ...
    workshops: {
      ...
      description: "Stop juggling spreadsheets and sticky notes. Bitácora gives your workshop digital tools for scheduling, service tracking, customer management, and parts inventory — so you can focus on fixing vehicles.",
      cta: "Get Started",
      viewPricing: "View Pricing",
      preview: "Dashboard Preview",
      ...
      ctaDesc: "Join repair shops using Bitácora to streamline operations.",
      ctaButton: "Start Free Trial",
      ctaFootnote: "No commitment. Cancel anytime.",
    },
    construction: {
      ...
      description: "Stop tracking hours on spreadsheets. Bitácora gives you a complete view of your construction equipment fleet — hours, maintenance, site assignments, and equipment status, all in one place.",
      cta: "Get Started",
      viewPricing: "View Pricing",
      preview: "Dashboard Preview",
      ...
      ctaDesc: "Join construction companies using Bitácora to reduce downtime.",
      ctaButton: "Start Free Trial",
      ctaFootnote: "No commitment. Cancel anytime.",
    },
  },
  ...
  dashboard: {
    ...
    settings: {
      ...
      orgName: "Organization Name",
      slug: "Slug",
      slugHelper: "Used in URLs: bitacora.app/{slug}",
      ...
      industryTypeHelper: "Controls what labels and navigation items your organization sees.",
    ...
    vehicleDetail: {
      ...
      checkingRecalls: "Checking for recalls...",
      ...
      estimatingValue: "Estimating value...",
      failedLoadValue: "Could not load value report.",
      ...
      pdfFooter: "Bitácora | Professional Fleet & Vehicle Management System",
      ...
      failedLoadDocuments: "Could not load documents. Please try again.",
    ...
    vehicleTasks: {
      heading: "Tasks",
      subtitle: "Prioritized repairs, maintenance, and upgrades",
      addTask: "Add Task",
      noTasks: "No tasks yet",
      addFirstTask: "Add your first task to get prioritized recommendations",
      editTask: "Edit Task",
      categories: {
      ...
      buildGoalTags: {
        ...
        offroad_build: "Off-road Build",
        resale_prep: "Resale Prep",
      ...
      forms: {
        ...
        templatePicker: "Build Path Templates",
      },
      priorityExplanation: "Priority score",
  ...
  industries: {
    construction: "Construction / Fleet Operations",
    dealership: "Dealership",
    mechanic: "Independent Mechanic / Repair Shop",
    rental: "Rental Company",
    default: "Other / General Fleet",
  },
  industryNav: {
    construction: {
      constructionSites: "Construction Sites",
  ...
  industryPages: {
    construction: {
      constructionSites: { heading: "Construction Sites", subtitle: "Manage your construction sites and equipment", action: "New Site", newHeading: "New Construction Site", saveAction: "Create Site" },
      ...
      serviceProviders: { heading: "Service Providers", subtitle: "Manage your service providers and vendors", action: "Add Provider", newHeading: "New Service Provider", saveAction: "Add Provider" },
    ...
    dealership: {
      constructionSites: { heading: "Lots & Showroom", subtitle: "Manage your lots and showroom inventory", action: "New Lot", newHeading: "New Lot", saveAction: "Create Lot" },
      ...
      serviceProviders: { heading: "Service Dept", subtitle: "Manage your service department", action: "Add Provider", newHeading: "New Service Provider", saveAction: "Add Provider" },
    ...
    mechanic: {
      constructionSites: { heading: "Locations", subtitle: "Manage your shop locations", action: "New Location", newHeading: "New Location", saveAction: "Create Location" },
      ...
      serviceProviders: { heading: "Suppliers", subtitle: "Manage your parts suppliers and vendors", action: "Add Supplier", newHeading: "New Supplier", saveAction: "Add Supplier" },
    ...
    rental: {
      constructionSites: { heading: "Pickup Locations", subtitle: "Manage your rental pickup locations", action: "New Location", newHeading: "New Pickup Location", saveAction: "Create Location" },
      ...
      serviceProviders: { heading: "Vendors", subtitle: "Manage your vendors and partners", action: "Add Vendor", newHeading: "New Vendor", saveAction: "Add Vendor" },
    ...
    default: {
      constructionSites: { heading: "Locations", subtitle: "Manage your locations", action: "New Location", newHeading: "New Location", saveAction: "Create Location" },
      parts: { heading: "Inventory", subtitle: "Track your inventory", action: "Add Item", newHeading: "New Item", saveAction: "Add Item" },
      serviceProviders: { heading: "Vendors", subtitle: "Manage your vendors", action: "Add Vendor", newHeading: "New Vendor", saveAction: "Add Vendor" },
  ...
  wallet: {
    ...
    tapToAddPolicy: "Tap to add policy",
    noInsurancePolicy: "No Insurance Policy Added",
    uploadInsuranceDesc: "Upload your insurance card to keep it in your digital wallet",
    uploadInsuranceCard: "Upload Insurance Card",
    ...
    addVehicleForRegistration: "Add a vehicle to see registration details",
    roadsideAssistance: "Roadside Assistance",
    emergency247: "24/7 Emergency",
    tapToSetup: "Tap to set up",
    noRoadsideCoverage: "No Roadside Coverage",
    addRoadsideMembership: "Add your roadside assistance membership for quick access in emergencies",
    setUpCoverage: "Set Up Coverage",
    className: "Class",
    scanToVerify: "Scan to verify license",
    expired: "Expired",
    expiring: "Expiring",
    actionRequired: "Action Required",
    expiredDocsRenew: (n: number) => `${n} document${n > 1 ? "s" : ""} expired — renew now`,
    someExpiringSoon: "Some documents expiring soon",
  ...
  authorizations: {
    ...
    none: "No workshop has access to this vehicle.",
    pending: "Pending",
    active: "Has access",
    ...
    revokeConfirmTitle: "Remove this workshop's access?",
    revokeConfirmBody: "It will not be able to log new services. The history it already recorded is kept.",
  ...
  workshop: {
    title: "Service Desk",
    subtitle: "Log a service for a customer in four steps.",
    ...
    back: "Back",
    continue: "Continue",
    customerSearchTitle: "Find customer",
    customerSearchHint: "Search by national ID, phone or email.",
    customerSearchPlaceholder: "ID, phone or email",
    search: "Search",
    customerFound: "Customer found",
    customerNotFound: "Not found. Register them below.",
    newCustomer: "New customer",
    customerName: "Full name",
    customerEmail: "Email address",
    customerPhone: "Phone",
    customerDocument: "National ID",
    createCustomer: "Register customer",
    useThisCustomer: "Use this customer",
    vehicleSearchTitle: "Find vehicle by plate",
    vehicleSearchHint: "Avoids creating a duplicate of a vehicle already on file.",
    platePlaceholder: "License plate",
    vehicleFound: "Vehicle found",
    vehicleNotFound: "Not found. Register it below.",
    vehicleNotAuthorized: "This vehicle exists but your workshop is not authorized to log services on it.",
    requestAuthorization: "Request access from the owner",
    requestSent: "Request sent. The owner will be notified to approve it.",
    requestPending: "There is already a pending request for this vehicle.",
    ...
    vin: "VIN",
    mileage: "Mileage",
    createVehicle: "Register vehicle",
    useThisVehicle: "Use this vehicle",
    serviceTitle: "Log service",
    serviceType: "Service type",
    description: "Description",
    estimatedHours: "Estimated time (hours)",
    cost: "Cost",
    invoicePhoto: "Invoice photo (optional)",
    status: "Status",
    statusInProgress: "In progress",
    statusReady: "Ready for pickup",
    statusCompleted: "Completed",
    createReminder: "Create a reminder for the next service",
    saveService: "Save and notify",
    savedTitle: "Service logged",
    savedBody: "It was added to the customer's history and they have been notified.",
    nextServiceSuggested: "Suggested next service",
    startAnother: "Log another service",
    historyTitle: "Workshop history",
    historySubtitle: "Services your workshop has logged.",
    historyEmpty: "You have not logged any services yet.",
    filterAll: "All",
    ...
    confirmedYes: "Confirmed by customer",
    confirmedNo: "Not confirmed",
    markReady: "Mark ready",
    markCompleted: "Mark completed",
    confirmTitle: "Confirm receipt",
    confirmBody: "Let your workshop know you received the notice for this service.",
    confirmButton: "Confirm I received it",
    confirmDone: "Thanks! Your workshop knows you received it.",
    confirmAlready: "You already confirmed this notice.",
    notWorkshop: "Your account is not linked to a workshop. Switch organization or ask the owner for access.",
